...
// const selectedFilters = reactive({
//     category: defaultFormFields.categorySelect,
//     priceFrom: defaultFormFields.priceFromInput,
//     priceTo: defaultFormFields.priceToInput,
//     orderBy: defaultFormFields.orderBySelect,
// });
...
<template>
    <!-- <form @submit.prevent="onFiltersSubmit"> -->
        <div class="mb-3">
